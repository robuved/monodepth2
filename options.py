...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--imu_data_path",
                                 type=str,
                                 help="path to the training imu data",
                                 default='')
        ...
        self.parser.add_argument("--split",
                                 ...
                                 choices=["eigen_zhou", "eigen_full", "odom", "benchmark", "raw_odometry", "raw_odometry_small"],
                                 default="eigen_zhou")
        ...
        self.parser.add_argument("--eval_split",
                                 ...
                                 default="eigen",
                                 choices=[
                                    "eigen", "eigen_benchmark", "benchmark", "odom_9", "odom_10", "raw_odometry"],
